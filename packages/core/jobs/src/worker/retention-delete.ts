...
export async function deleteExpiredDeduplication(
  ...
  const result = await executor.query(
    `DELETE FROM "damat"."_damat_job_deduplication" WHERE ("queue","job_name","deduplication_key") IN (
       SELECT "queue","job_name","deduplication_key" FROM "damat"."_damat_job_deduplication"
...
export async function deleteTerminalJobRuns(
  ...
  const result = await executor.query(
    `DELETE FROM "damat"."_damat_job_runs" WHERE "id" IN (
       SELECT "id" FROM "damat"."_damat_job_runs"
