...
export async function deleteExpiredDurableEvents(
  ...
  const result = await executor.query(
    `DELETE FROM "damat"."_damat_event_outbox" WHERE "id"=ANY($1::uuid[])`,
    [deletable],
  );
