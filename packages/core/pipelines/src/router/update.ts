...
export async function finishNode(
  ...
  await executor.query(
    `UPDATE "damat"."_damat_pipeline_node_executions" SET "status"=$2,
...
export async function waitNode(
  ...
  await executor.query(
    `UPDATE "damat"."_damat_pipeline_node_executions" SET "status"='waiting',
  ...
  await executor.query(
    `UPDATE "damat"."_damat_pipeline_runs" SET "status"='waiting',"updated_at"=NOW()
